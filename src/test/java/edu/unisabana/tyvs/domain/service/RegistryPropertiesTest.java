...
class RegistryPropertiesTest {
    ...
    void nuncaDevuelveNullNiLanzaExcepcion(
        ...
        /**
     * Regla R5 (regla de negocio): todo menor de edad se rechaza con UNDERAGE,
     * sin importar id, nombre o género — mientras esté vivo.
     */
    @Property
    ...
    /**
     * Regla R7 (regla de negocio): todo adulto con id válido y sin duplicar
     * se registra como VALID.
     */
    @Property
    ...
    /**
     * Propiedad ESTRUCTURAL de invariante de partición: el resultado siempre
     * es uno de los valores del enum, sin importar la combinación de entrada.
     */
    @Property
